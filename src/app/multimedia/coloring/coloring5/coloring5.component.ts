...
@Component({
  selector: 'app-coloring5',
  templateUrl: './coloring5.component.html',
  styleUrls: ['./coloring5.component.css']
})
export class Coloring5Component implements OnInit {
  canvas: any;
  paths: any = [];
  img: any = 'assets/img/coloring/grape.png';
  brushWidthRange: any;
