...
@Component({
  selector: 'app-coloring3',
  templateUrl: './coloring3.component.html',
  styleUrls: ['./coloring3.component.css']
})
export class Coloring3Component implements OnInit {

  canvas: any;
  paths: any = [];
  img: any = 'assets/img/coloring/banana.png';
  brushWidthRange: any;
