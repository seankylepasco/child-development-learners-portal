...
@Component({
  selector: 'app-coloring6',
  templateUrl: './coloring6.component.html',
  styleUrls: ['./coloring6.component.css']
})
export class Coloring6Component implements OnInit {

  canvas: any;
  paths: any = [];
  img: any = 'assets/img/coloring/strawberry.png';
  brushWidthRange: any;
