...
@Component({
  selector: 'app-coloring4',
  templateUrl: './coloring4.component.html',
  styleUrls: ['./coloring4.component.css']
})
export class Coloring4Component implements OnInit {
  canvas: any;
  paths: any = [];
  img: any = 'assets/img/coloring/orange.png';
  brushWidthRange: any;
