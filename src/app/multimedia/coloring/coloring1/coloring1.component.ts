...
@Component({
  selector: 'app-coloring1',
  templateUrl: './coloring1.component.html',
  styleUrls: ['./coloring1.component.css']
})
export class Coloring1Component implements OnInit {
  canvas: any;
  paths: any = [];
  img: any = 'assets/img/coloring/apple.png';
  brushWidthRange: any;
