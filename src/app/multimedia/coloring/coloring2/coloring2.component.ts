...
@Component({
  selector: 'app-coloring2',
  templateUrl: './coloring2.component.html',
  styleUrls: ['./coloring2.component.css']
})
export class Coloring2Component implements OnInit {

  canvas: any;
  paths: any = [];
  img: any = 'assets/img/coloring/mango.png';
  brushWidthRange: any;
