...
@Component({
  selector: 'app-coloring8',
  templateUrl: './coloring8.component.html',
  styleUrls: ['./coloring8.component.css']
})
export class Coloring8Component implements OnInit {
  canvas: any;
  paths: any = [];
  img: any = 'assets/img/coloring/avocado.png';
  brushWidthRange: any;
