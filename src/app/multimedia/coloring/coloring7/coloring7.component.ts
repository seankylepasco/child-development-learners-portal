...
@Component({
  selector: 'app-coloring7',
  templateUrl: './coloring7.component.html',
  styleUrls: ['./coloring7.component.css']
})
export class Coloring7Component implements OnInit {

  canvas: any;
  paths: any = [];
  img: any = 'assets/img/coloring/watermelon.png';
  brushWidthRange: any;
  ...
  createCanvas(): void {
    ...
    this.canvas.setBackgroundImage(
      ...
      {
        scaleX: this.canvas.width / 1500,
        scaleY: this.canvas.height / 1500,
      }
    );
  }
