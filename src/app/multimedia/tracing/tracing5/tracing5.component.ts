...
@Component({
  selector: 'app-tracing5',
  templateUrl: './tracing5.component.html',
  styleUrls: ['./tracing5.component.css']
})
export class Tracing5Component implements OnInit {

  
  canvas: any;
  paths: any = [];
  img: any = 'assets/img/tracing/triangle.png';
  brushWidthRange: any;
