...
@Component({
  selector: 'app-tracing1',
  templateUrl: './tracing1.component.html',
  styleUrls: ['./tracing1.component.css']
})
export class Tracing1Component implements OnInit {

  canvas: any;
  paths: any = [];
  img: any = 'assets/img/tracing/heart.png';
  brushWidthRange: any;
