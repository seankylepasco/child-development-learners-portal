...
@Component({
  selector: 'app-tracing7',
  templateUrl: './tracing7.component.html',
  styleUrls: ['./tracing7.component.css']
})
export class Tracing7Component implements OnInit {

  canvas: any;
  paths: any = [];
  img: any = 'assets/img/tracing/diamond.png';
  brushWidthRange: any;
  ...
  createCanvas(): void {
    ...
    this.canvas.setBackgroundImage(
      ...
      {
        scaleX: this.canvas.width / 3000,
        scaleY: this.canvas.height / 3400,
      }
    );
  }
