...
@Component({
  selector: 'app-tracing2',
  templateUrl: './tracing2.component.html',
  styleUrls: ['./tracing2.component.css']
})
export class Tracing2Component implements OnInit {

 
  canvas: any;
  paths: any = [];
  img: any = 'assets/img/tracing/star.png';
  brushWidthRange: any;
