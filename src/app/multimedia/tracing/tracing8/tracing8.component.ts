...
@Component({
  selector: 'app-tracing8',
  templateUrl: './tracing8.component.html',
  styleUrls: ['./tracing8.component.css']
})
export class Tracing8Component implements OnInit {

  
  canvas: any;
  paths: any = [];
  img: any = 'assets/img/tracing/octagon.png';
  brushWidthRange: any;
