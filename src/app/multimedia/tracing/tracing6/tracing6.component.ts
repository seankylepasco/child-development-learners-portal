...
@Component({
  selector: 'app-tracing6',
  templateUrl: './tracing6.component.html',
  styleUrls: ['./tracing6.component.css']
})
export class Tracing6Component implements OnInit {

  
  canvas: any;
  paths: any = [];
  img: any = 'assets/img/tracing/oval.png';
  brushWidthRange: any;
