...
@Component({
  selector: 'app-tracing4',
  templateUrl: './tracing4.component.html',
  styleUrls: ['./tracing4.component.css']
})
export class Tracing4Component implements OnInit {

  canvas: any;
  paths: any = [];
  img: any = 'assets/img/tracing/square.png';
  brushWidthRange: any;
